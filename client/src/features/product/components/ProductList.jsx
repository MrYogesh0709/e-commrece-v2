...
const ProductList = () => {
  ...
  }, [dispatch, filter, sort, page, searchRef.current?.value]);
      ...
      <div>
        ...
        <form onSubmit={handleSearch} className="px-4">
          <div className="pt-2  text-gray-600 flex items-center">
            <input
              className="border-2 border-gray-300 dark:bg-slate-600 dark:text-slate-200 bg-white h-10 px-5 rounded-lg text-sm focus:outline-none w-full"
              type="search"
              name="search"
              ref={searchRef}
              placeholder="Search"
            ...
            <button type="submit" className="ml-4">
              <svg
                className="text-gray-600 h-6 w-6 fill-current dark:text-slate-300"
